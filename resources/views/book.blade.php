        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h4>Book Information <a href="#" class="btn btn-warning btn-outline" data-toggle="modal"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="description" type="text"
                                                ...
                                                value="{{ old('description',$book->description) }}"  autocomplete="description" >
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="edition" type="number"
                                                ...
                                                value="{{ old('edition',$book->edition) }}" required autocomplete="edition" >
                                            @error('edition')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="pub_year" type="text"
                                                ...
                                                value="{{ old('pub_year',$book->pub_year) }}" required autocomplete="pub_year" >
                                            @error('pub_year')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
